...
namespace Application.Repository
{
    public class ShipmentRepository : IShipmentRepository
    {
        ...
        public async Task<IEnumerable<Client>?> GetClientsUsedInShipmentAsync()
        {
            using (AppDbContext db = new AppDbContext())
            {
                var query = db.Shipments
        ...
        public async Task<List<string>?> GetShipmentsNumbersAsync()
        {
            using (AppDbContext db = new AppDbContext())
            {
                return await db.Shipments.Select(s => s.Number).ToListAsync();
            }
        }

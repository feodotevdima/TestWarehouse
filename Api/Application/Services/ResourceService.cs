...
namespace Application.Services
{
    public class ResourceService : IResourceService
    {
        ...
        public ResourceService(IResourceRepository resourceRepository, IShipmentResourceRepository shipmentResourceRepository, IIncomeResourceRepository incomeResourceRepository, IBalanceRepository balanceRepository) 
        {
        ...
        public async Task<bool> CheckResourceToUse( Guid id)
        {
            ...
            var balance = await _balanceRepository.GetFiltredBalanceAsync(resourceIds: new List<Guid> { id });

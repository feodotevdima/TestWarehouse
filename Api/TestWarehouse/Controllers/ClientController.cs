...
namespace TestWarehouse.Controllers
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        public ClientController(IClientRepository clientRepository, IClientService clientService, IShipmentRepository shipmentRepository)
        {
        ...
        public async Task<IResult> GetClientsUseInShipmentsAsync()
        {
            var clients = await _shipmentRepository.GetClientsUsedInShipmentAsync();
            return Results.Ok(clients);
        }

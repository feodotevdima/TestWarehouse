...
namespace TestWarehouse.Controllers
{
    ...
    public class IncomeController : ControllerBase
    {
        ...
        [HttpGet("numbers")]
        public async Task<IResult> GetIncomeNumbersAsync()
        {
            var numbers = await _incomeRepository.GetIncomeNumbersAsync();
        ...
        {
            var income = await _incomeRepository.GetIncomeDtoByIdAsync(id);
            return Results.Ok(income);
        }
        ...
        [HttpDelete("{id}")]
        public async Task<IResult> DeleteIncomeAsync(Guid Id)
        {

...
namespace Application.Services
{
    public class UnitService : IUnitService
    {
        ...
        public UnitService(IUnitRepository unitRepository, IShipmentResourceRepository shipmentResourceRepository, IIncomeResourceRepository incomeResourceRepository) 
        {

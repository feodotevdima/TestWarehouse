...
namespace Application.Interfaces
{
    ...
    {
        Task<IEnumerable<GetShipmentDto>> GetFiltredShipmentDtosAsync(DateTime? start = null, DateTime? end = null, List<string>? numbers = null, List<Guid>? clientIds = null, List<Guid>? resourceIds = null, List<Guid>? unitIds = null);
